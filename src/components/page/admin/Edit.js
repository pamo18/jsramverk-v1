        ...
        return (
            <div className="form-wrapper">
                ...
                <form action="/reports/week/1" method="post" className="form-register" onSubmit={this.registerSubmit}>
                        ...
                        <textarea className="form-input textarea" type="text" name="content" onChange={this.updateText} value={this.state.current.content} required placeholder="Select the report to edit"></textarea>
                        </label>
